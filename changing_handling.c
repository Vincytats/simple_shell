...
/**
 * cd_dot -changes current direction
...
/**
 * cd_to - changes current directory to a specified path
 * @datash: data structure containing information about the shell
 * Return: void
 */
...
/**
 * cd_previous - changes current directory to previous working one
...
/**
 * cd_to_home - changes current directory to user's home directory
 * @datash: data structure containing info about shell
 * Return: void
 */
