...
/**
 * struct data -data structure to store information
 * @av: array of strings
 * @input: buffer to store user's input
...
/**
 * struct line_list_s - structure for a linked list of lines
...
/**
 * struct r_var_list - structure for a linked list
 * @len_var: length of the variable
 * @val: value to replace the variable with
 * @len_val: length of the replacement value
 * @next: pointer to the next node
 * Description: This structure is used to create a linked list of replacement
 */
...
/**
 * struct builtin_s - structure for builtin commands in the shell
